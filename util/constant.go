...
var Role = []string{"normal", "organizer"}
var CompetitionStatus = []string{"Coming soon", "Applications opening", "Started", "Finished", "Cancelled"}
var Sport = []string{"Football", "Futsal"}
